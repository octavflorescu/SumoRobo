...
#define power65P (int16_t)(power * 0.65)
#define power60P (int16_t)(power * 0.6)
#define power55P (int16_t)(power * 0.55)
...
#define whiteThreshold 180 // max white

long defaultForwardTime = 225;
...
#define WriteMotors(m1, m2) \
  ({ \
    ...
    sRawPacket_mds.sMotorCommand.pMotorL_sds16 = (int16_t)(-m2 * 0.965); \
